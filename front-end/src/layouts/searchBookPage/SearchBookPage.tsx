            ...
            <div className="px-8">
                <div className="flex flex-col justify-between items-center gap-y-2 md:flex-row md:items-center md:justify-start gap-x-3 w-full">
                    <form className="w-full md:w-2/5">
                        ...
                        <div className="relative">
                            ...
                            <input
                              ...
                              focus:ring-blue-700  dark:bg-gray-700
                    ...
                    <div id="dropdownmeu" className="relative">
                        ...
                        <div id="dropdown"
                            className={`z-10 ${!toggle && "hidden"} absolute bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
                            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                {
                                    categories.map((item, i) => (
                                        <li key={i} onClick={() => categoryField(item.value)}>
                                            <span
                                                className="block mx-1 rounded-md font-bold px-4 py-2 hover:bg-slate-300 dark:hover:bg-gray-600 dark:hover:text-white"> {item.name}</span>
                                        </li>
                                    ))
                                }
                            </ul>
                            ...
                            <div className="p-4 flex flex-col justify-center items-center h-96">
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <a className="group inline-flex items-center h-9 rounded-full text-sm font-semibold whitespace-nowrap px-3 focus:outline-none focus:ring-2 bg-sky-50 text-sky-600 hover:bg-sky-100 hover:text-sky-700 focus:ring-sky-600 dark:bg-slate-700 dark:text-slate-100 dark:hover:bg-slate-600 dark:hover:text-white dark:focus:ring-slate-500 mt-8"
                                        href="#">Check Library Services<span className="sr-only">, reusing styles</span><svg className="overflow-visible ml-3 text-sky-300 group-hover:text-sky-400 dark:text-slate-500 dark:group-hover:text-slate-400" width="3" height="6" viewBox="0 0 3 6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M0 0L3 3L0 6"></path></svg></a>
