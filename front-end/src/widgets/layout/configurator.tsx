        ...
        <div className="mb-12">
          ...
          <div className="mt-3 flex items-center gap-2">
            <Button
              ...
              className={sidenavType === "dark" ? "bg-black" : "bg-white text-black"}
            >
              Dark
            </Button>
            <Button
              onClick={() => setSidenavType(dispatch, "transparent")}
              className={sidenavType === "transparent" ? "bg-black" : "bg-white text-black"}
            >
              Transparent
            </Button>
            <Button
              className={sidenavType === "white" ? "bg-black" : "bg-white text-black"}
